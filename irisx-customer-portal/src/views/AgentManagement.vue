            ...
            <tr v-for="agent in filteredAgents" :key="agent.id">
              ...
              <td>
                <div class="flex gap-2">
                  ...
                  >
                    <svg class="h-6 w-6 w-4 h-4" v-if="agent.status === 'active'"  fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <svg class="h-6 w-6 w-4 h-4" v-else  fill="none" stroke="currentColor" viewBox="0 0 24 24">
