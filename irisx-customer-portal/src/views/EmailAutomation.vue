        ...
        >
          <div class="rule-header">
            ...
            <div class="rule-actions">
              ...
              >
                <svg v-if="rule.enabled" class="icon text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <svg v-else class="icon text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
