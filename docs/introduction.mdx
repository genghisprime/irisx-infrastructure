---
title: Introduction
description: 'Welcome to Tazzi - Multi-Channel Communications Platform'
---

## What is Tazzi?

Tazzi is a powerful, developer-friendly communications platform that enables you to integrate voice calls, SMS, and email into your applications. Built for scale and reliability, Tazzi provides enterprise-grade features at startup-friendly prices.
...
```mermaid
graph TD
    A[Your Application] -->|API Calls| B[Tazzi API]
    B -->|Webhooks| A
...
- 💬 Discord: [Join our community](https://discord.gg/tazzi)
- 📚 Docs: You're already here!
- 🐛 Issues: [GitHub](https://github.com/tazzi/issues)
